...
provincia_Clus=as.data.frame(data_clus$cluster)#se combina la información y el mapa en un cluster
...
peruMap_TOTAL=merge(peruMap, provincia_Clus)#objeto final
myColors=rainbow(5)
